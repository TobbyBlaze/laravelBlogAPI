...
<script>if (top != self) { top.location.replace(self.location.href); }</script></head>

<body class="bp-legacy page-template-default page page-id-223 gp-theme sb-both gp-fixed-header gp-back-to-top-all gp-lightbox-group gp-profile-all gp-has-title gp-responsive gp-retina no-js">
	...
	<div id="page-wrapper">
		...
		<header id="header">
			...
			<div id="logo" style="" class="default-logo">
				...
				<a href="https://buddy.ghostpool.com/" title="Buddy">
					<img src="connect.png" width="108" height="25" alt="Blaze Social" />
				</a>
			...
			<nav id="nav">		
									...
									<ul id="menu-header" class="menu"><li id="menu-item-511" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-511"><a href="/home">Home</a></li>
										<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="notification" aria-current="page">Notifications</a></li>
										<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="https://www.muritalatobi.blogspot.com" aria-current="page">Blog</a></li>
<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="user/{{Auth::user()->id}}" aria-current="page">Profile</a></li>
</ul>				
											
					<div id="bp-buttons"> <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="button bp-button signup-button">Log out</a>						
			...
			<nav id="mobile-nav">
					...
					<div id="mobile-bp-buttons"> <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="bp-button signup-button">Log out</a>						
				...
				<ul class="menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-511"><a href="/">Home</a></li>

<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="notification" aria-current="page">Notifications</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="" aria-current="page">Blog</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-476"><a href="user/{{Auth::user()->id}}">Profile</a></li>
</ul>				
			</nav>
	...
	<aside id="sidebar-left" class="sidebar">
					...
					<div id="search-2" class="widget widget_search"><form method="post" class="search-form" action="found-all">
	...
	<input type="text" name="q" class="gp-search-bar" value="" placeholder="Search" /><input type="submit" class="gp-search-submit" value="Search" />
...
</form></div><div id="bp_core_members_widget-1" class="widget widget_bp_core_members_widget buddypress widget"><h3 class="widgettitle"><a href="https://buddy.ghostpool.com/members/">Users</a></h3>
		
			<div class="item-options" id="members-list-options"> <span class="bp-separator" role="separator">|</span>
				...
				@foreach ($users as $user)
					<li class="vcard">
						<div class="item-avatar">
							<a href="https://buddy.ghostpool.com/members/reneegomez/" class="bp-tooltip" data-bp-tooltip="Renee Gomez"><img src="" class="avatar user-4-avatar avatar-58 photo" width="58" height="78" alt="Profile picture of {!!$user->name!!}" /></a>
						</div>

						<div class="item">
							<div class="item-title fn">
								
									<a href="" class="black">{!!$user->name!!} </a><br />
								
							</div>
							<div class="item-meta">
																	<span class="activity"> {{$followings->count()}} followings </span>
															</div>
															<div class="item-meta">
																	<span class="activity"> {{$followers->count()}} followers </span>
															</div>
						</div>
					</li>
				@endforeach
		...
		</div><div id="calendar-1" class="widget widget_calendar"><h3 class="widgettitle">The Schedule</h3><div id="calendar_wrap" class="calendar_wrap"><table id="wp-calendar">
	...
	<tfoot>
	<tr>
		<td colspan="3" id="prev"><a href="https://buddy.ghostpool.com/2015/11/">&laquo; Nov</a></td>
		<td class="pad">&nbsp;</td>
...
<div id="gp-statistics-widget-5" class="widget gp-statistics">		
		<h3 class="widgettitle">Statistics</h3>		
			...
			<div class="gp-stats">
							...
							<span class="gp-stat-count"> {{$posts->count()}} </span>
						</span>	
					</div>
<div class="gp-member-stats">
			<span class="gp-stat-details">
				<span class="gp-stat-title">Followers</span>
				<span class="gp-stat-count"> {{$followers->count()}} </span>
			</span>	
			</div>
<div class="gp-member-stats">
			<span class="gp-stat-details">
				<span class="gp-stat-title">Followings</span>
				<span class="gp-stat-count"> {{$followings->count()}} </span>
			</span>	
			</div>
</div>
						
			</div><div id="bp_core_whos_online_widget-1" class="widget widget_bp_core_whos_online_widget buddypress widget"><h3 class="widgettitle">Who&#8217;s Online</h3>
		...
		<div class="sc-image aligncenter      " style="  width: 182px; height: 124px;">
			...
			<a href="#" title="" data-rel="noopener noreferrer" target="_self">
		
				<img src="connect.png" data-rel="" alt="Campus Connect" width="182" height="124" /> 
...
<div class="footer-widget footer-4 footer-fourth">
	<div id="text-2" class="widget widget_text"><h3><a href="" class="widgettitle">About Us</a></h3>			<div class="textwidget"> </div>
		</div>					</div>
	...
	<div id="copyright">
					Copyright &copy; 2019 <a href="">Campus Connect</a>. All rights reserved.			</div>
